...
interface UserLandingProductSearchProps {
  rowIndex: number
  addProductToList: Function
}

function UserLandingProductSearch({
  addProductToList,
  rowIndex,
}: UserLandingProductSearchProps) {
  ...
  return (
    <div className="w-2/3 relative md:w-2/6  mx-auto flex items-baseline">
      <div className="relative w-full">
        ...
        {data && (
          <div className="absolute z-50 pb-8 top-13 max-h-5/6 overflow-hidden w-full border shadow-lg rounded-lg bg-white">
            ...
            {data?.search_data?.map((product) => (
              ...
              >
                ...
                <button
                  onClick={() => {
                    addProductToList(rowIndex, product)
                  }}
...
export default UserLandingProductSearch
